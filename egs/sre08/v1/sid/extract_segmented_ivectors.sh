...
## Set up features.
feats="ark,s,cs:concat-feat-segments scp:$sdata/JOB/feats.scp $sdata/JOB/segments ark:- | add-deltas $delta_opts ark:- ark:- | apply-cmvn-sliding --norm-vars=false --center=true --cmn-window=300 ark:- ark:- | select-voiced-frames ark:- \"ark:concat-vad-segments scp:$sdata/JOB/vad.scp $sdata/JOB/segments ark:-|\" ark:- |"
...
if [ $stage -le 2 ]; then
  ...
  $cmd $dir/log/speaker_mean.log \
    ...
    ivector-mean ark:$data/segspk2utt ark:- ark:- ark,t:$dir/num_utts.ark \| \
