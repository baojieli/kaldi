...
### Prepare mix lists
  ...
  local/filelist_to_mixlist.py --write-stats True --target-mix-num 5000 tmp_mix/cv/CH02/filelist.txt \
    mixes/mix_2_spk_CH02_cv.txt
  local/filelist_to_mixlist.py --write-stats True --target-mix-num 3000 tmp_mix/tt/CH02/filelist.txt \
    mixes/mix_2_spk_CH02_tt.txt
  local/filelist_to_mixlist.py --write-stats True --target-mix-num 20000 tmp_mix/tr/CH02/filelist.txt \
